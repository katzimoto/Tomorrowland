...
# Feature flags
FEATURE_LOCAL_LLM_DEV="$(prompt_yesno "FEATURE_LOCAL_LLM_DEV" "false")"
...
MEILISEARCH_VOLUME="$(prompt "TOMORROWLAND_MEILISEARCH_VOLUME" "tomorrowland_meilisearch_data")"
...
OLLAMA_LLM_VOLUME="$(prompt "TOMORROWLAND_OLLAMA_LLM_VOLUME" "tomorrowland_ollama_llm_data")"
OLLAMA_EMBED_VOLUME="$(prompt "TOMORROWLAND_OLLAMA_EMBED_VOLUME" "tomorrowland_ollama_embed_data")"
...
out+="# Feature flags\n"
out+="FEATURE_LOCAL_LLM_DEV=${FEATURE_LOCAL_LLM_DEV}\n"
...
out+="TOMORROWLAND_MEILISEARCH_VOLUME=${MEILISEARCH_VOLUME}\n"
out+="TOMORROWLAND_QDRANT_VOLUME=${QDRANT_VOLUME}\n"
out+="TOMORROWLAND_LIBRETRANSLATE_VOLUME=${LIBRETRANSLATE_VOLUME}\n"
out+="TOMORROWLAND_OLLAMA_LLM_VOLUME=${OLLAMA_LLM_VOLUME}\n"
out+="TOMORROWLAND_OLLAMA_EMBED_VOLUME=${OLLAMA_EMBED_VOLUME}\n"
