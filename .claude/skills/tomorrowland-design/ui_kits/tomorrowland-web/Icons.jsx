/* global React */
// Lightweight inline icon set — same shapes as Lucide.
// Avoids the lucide UMD's DOM-mutation lifecycle, which conflicts with React.
...
const ICONS = {
  ...
  archive: <><rect x="3" y="4" width="18" height="4" rx="2"/><path d="M3 8v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8"/><path d="M10 12h4"/></>,
...
function Icon({ name, size = 20, strokeWidth = 1.8, style }) {
